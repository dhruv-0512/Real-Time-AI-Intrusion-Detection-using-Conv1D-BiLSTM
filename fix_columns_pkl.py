...
joblib.dump(columns_array, os.path.join("models", "columns.pkl"))

print(f"[OK] columns.pkl regenerated - {len(COLUMNS)} features")
print(f"  NumPy version : {np.__version__}")
print(f"  First 5 cols  : {COLUMNS[:5]}")
print(f"  Last  5 cols  : {COLUMNS[-5:]}")
print("\nNow run:")
print("  py -3.10 realtime_ids.py --iface 4 --model fixed_model.keras")